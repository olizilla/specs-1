...
$\line{4}{\bi}{\llcorner c \lrcorner_{2, \textsf{le}}: \Bit^{[\log_2(N_\nodes)]} = \Big\|_{\el \in \BinTreeProof_c\dot\path} \thin \el\dot\missing}$

$\line{5}{\bi}{\llcorner c \lrcorner_{8, \textsf{le}}: [8]^{[\log_8(N_\nodes)]} \ \ \ \ \ \thin = \Big\|_{\el \in \OctTreeProof_c\dot\path} \thin \el\dot\missing}$

$\line{6}{\bi}{\llcorner c \lrcorner_{2, \textsf{le}}: \Bit^{[\log_2(N_\nodes)]} = \Big\|_{\el \in \OctTreeProof_c\dot\path} \thin \llcorner \el\dot\missing \lrcorner_{2, \textsf{le}}}$
```
...
$\bi\quad\quad \|_{\Label_{u, l_0} \in \ParentLabels_{\mathbf{u}_\drg}^\star}\ \Label_{u, l_0} \as \Byte^{[32]}$
```
...
$\bi\quad\quad \|\ \beencode(v \as \u{64}) \as \Byte^{[8]}$
$\bi\quad\quad \|_{\Label_u \in \ParentLabels_{\mathbf{u}_\total}^\star}\ \Label_u \as \Byte^{[32]}$
```
...
$\quad\quad \|_{\Label_u \thin\in\thin \parentlabels'}\ \Label_u \as \Byte^{[32]}$
...
$\quad\quad \|\ \nodeindex_{[\auxb, \be]}$
$\quad\quad \|\ 0^{[160]}$
$\quad\quad \|_{\parentlabel \in \parentlabels}\ \parentlabel_{[\auxb + \constb, \lebytes]}$
